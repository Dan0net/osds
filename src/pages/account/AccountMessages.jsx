...
export default function AccountMessages() {
  ...
  const [tab, setTab] = useState(searchParams.get('tab') === 'preferences' ? 'preferences' : 'messages')
    ...
    <div>
      ...
      <div className="flex gap-1 mb-4">
        <button
          ...
          className={`px-3 py-1.5 text-sm font-medium rounded-lg ${tab === 'messages' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
        >
          Messages
        </button>
        <button
          onClick={() => setTab('preferences')}
          className={`px-3 py-1.5 text-sm font-medium rounded-lg ${tab === 'preferences' ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
        >
          Preferences
        </button>
      </div>
