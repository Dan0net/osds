...
export default function LinkRow({ icon: Icon, label, value, secondary, to, state, right }) {
  const inner = (
    <>
      {Icon && (
  ...
  const className = 'flex items-center gap-3 bg-white border border-gray-200 rounded-lg px-3 py-2.5'
